...
import { NickNameHeaderName, SignalRClientHandlerName } from '../shared/Constants'
...
export class LoginState {
    ...
    login() {
        ...
        axios.defaults.headers.common[NickNameHeaderName] = this.nickNameInputText;

        // Mounting the event handler
        signalrConn.on(SignalRClientHandlerName, this.signalRMessageHandler);
